...
@Component({
    ...
    template: `
        ...
        <div class="page-container">
            <div class="card">
                <h1
                    style="margin-bottom: 30px; color: var(--dark-blue); font-size: 28px; text-align: center;"
                >
                    Детали заявки
                </h1>
                ...
                <div style="margin-top: 30px; text-align: center;">
                    <a routerLink="/student/requests" class="btn btn-secondary"
...
export class RequestDetailComponent implements OnInit {
    ...
    loadRequest(id: string) {
        ...
        this.userService.getRequest({ requestID: id }).subscribe({
            next: (response) => {
            ...
            error: (error) => {
                this.errorMessage =
                    error.message || "Не удалось загрузить информацию о заявке";
                this.isLoading = false;
            },
        });
    }
